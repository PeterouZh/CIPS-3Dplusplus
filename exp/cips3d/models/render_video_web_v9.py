...
from .projector_v9 import StyleGAN2Projector, StyleGAN2Projector_Flip
...
class STModel(object):
  ...
  def _flip_inversion_web(self,
    ...
    global_cfg.grad_clip_cam = st_utils.number_input('grad_clip_cam', cfg.grad_clip_cam, sidebar=True)
    global_cfg.grad_clip_render = st_utils.number_input('grad_clip_render', cfg.grad_clip_render, sidebar=True)
    global_cfg.grad_clip_decoder = st_utils.number_input('grad_clip_decoder', cfg.grad_clip_decoder, sidebar=True)
